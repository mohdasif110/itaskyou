	...
	<!--div class="row bg-row">
		<h5><b>TO Me</b></h5>
			...
			<div  class="col-md-12 pull-right" >
					...
					<a href="#aboutModal" data-toggle="modal" data-target="#myModal" class="btn btn-circle-lg btn-primary"><span class="panel-title">Total <p>10</p><span></a>
					
					<a href="#aboutModal" data-toggle="modal" data-target="#myModal" class="btn btn-circle-lg btn-default"><span class="panel-title">In Progress 
					<p>3</p><span></a>
					
					<a href="#aboutModal" data-toggle="modal" data-target="#myModal" class="btn btn-circle-lg btn-success"><span class="panel-title">Completed <p>3</p></span></a>
					
					<a href="#aboutModal" data-toggle="modal" data-target="#myModal" class="btn btn-circle-lg btn-danger"><span class="panel-title">Overdue <p>4</p></span></a>
					
					<a href="#aboutModal" data-toggle="modal" data-target="#myModal" class="btn btn-circle-lg btn-warning"><span class="panel-title">Pending <p>4</p></span></a>
					
					<a href="#aboutModal" data-toggle="modal" data-target="#myModal" class="btn btn-circle-lg btn-info"><span class="panel-title">Declined <p>4</p></span></a>
