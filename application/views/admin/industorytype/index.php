...
<div   class="right_col" role="main" ng-controller="industorytypeController as vm" >
		<div   class="">
		...
		<div class="page-title">
				...
				<div growl></div>
					...
					<div class="pull-right">
						<button class="btn btn-primary" type="button"   data-toggle="modal" data-target="#industoryTypeModal" data-whatever="@getbootstrap" >Add New industry Type</button>
					</div>
		...
		<div class="table-responsive">
                      <table class="table table-striped jambo_table bulk_action">
						...
						<td ng-bind="industorytype.type"></td>
						<td> 
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="exampleModalLabel">Add New Industry Type</h4>
        </div>
        <div class="modal-body">
        <form>
			<span style="color:red;text-align:center" ng-bind="message"></span>
			<div class="form-group">
              <label for="recipient-name" class="form-control-label">Industry Type:</label>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="exampleModalLabel">Edit Industry Type</h4>
        </div>
        <div class="modal-body">
          <form>
