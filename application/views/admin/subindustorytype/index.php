...
<div class="right_col" role="main" ng-controller="subindustorytypeController as vm" >
          <div class="">
                        ...
                        <thead>
                          <tr class="headings">
                            <!--th>
							 ...
							 <!--input type="text" ng-model="search" class="form-control" style="width:40% !important;" placeholder="Sub Industory Type"--> Sub industry Type
							 </th>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form  class="form-horizontal form-label-left">
			...
			<div class="form-group">
				<label class="control-label col-md-3" for="last-name">industry Type<span class="required"></span>
				</label>
				<div class="col-md-7">
				 <select class="form-control col-md-7 col-xs-12" tabindex="-1 name="industrytype" ng-model="industorytype">
