itaskyou.controller('groupsController', function($scope,$http, admin_base_url,growl) {
	...
	$scope.viewItem=function(groupID){
		//$('#ajaxspiner').fadeIn();
		 $http.post(admin_base_url+controllerName+"/get_group_detail" ,{'groupID':groupID})
		.then(function(response) {
